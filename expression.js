...
export default class Expression
{
    ...
    selectRule(expressionValue)
    {
        ...
        {
            return this.leftExpression.selectRule(expressionValue) || this.rightExpression.selectRule(expressionValue)
        }
        ...
        return this.expressionType.selectRule(expressionValue)
    }
    ...
    invertRule(expressionValue)
    {
        ...
        if(this.expressionType === ExpressionType.complementationType)
        {
            return this.leftExpression.selectRule(expressionValue)
        }
    ...
    getDerivation(expressionRange)
    {
        ...
        if(this.expressionType === ExpressionType.concatenationType)
        {
            if(this.leftExpression.selectRule())
            {
